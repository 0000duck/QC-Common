...
namespace QuantumConcepts.Common.Utils
{
    ...
    {
        private static readonly List<MimeType> MimeTypes = null;
        private static readonly Dictionary<string, MimeType> MimeTypesByExtension = null;

        static MimeTypeUtil()
        {
            //Create the mime types.
            MimeTypeUtil.MimeTypes = new List<MimeType>()
            {
                ...
                new MimeType("msi", "application/x-ole-storage"),
            ...
            MimeTypeUtil.MimeTypesByExtension = MimeTypeUtil.MimeTypes.ToDictionary(o => o.Extension, o => o);
        }
        ...
        public static string GetMimeType(string extension)
        {
            ...
            if (MimeTypeUtil.MimeTypesByExtension.ContainsKey(extension))
                return MimeTypeUtil.MimeTypesByExtension[extension].Type;
        ...
        {
            return MimeTypeUtil.MimeTypes.FirstOrDefault(o => o.Type.Equals(mimeType, StringComparison.InvariantCultureIgnoreCase)).ValueOrDefault(o => o.Extension);
        }
